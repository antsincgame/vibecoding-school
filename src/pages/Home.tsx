    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          <strong>Онлайн курсы vibe coding</strong> для подростков от 14 лет (с согласия родителей) и взрослых. Освойте <strong>Cursor AI</strong> или <strong>AI-инструментами</strong> — два направления для <strong>создания веб-приложений</strong> с помощью искусственного интеллекта.
        </p>
      ...
      <section style={{
        ...
        <h2 style={{
          ...
          Присоединяйтесь к онлайн-школе вайб-кодинга!
        </h2>
        ...
        <div className="cyber-card" style={{ padding: '30px' }}>
          ...
          <div style={{
            ...
            <p style={{ marginBottom: '20px' }}>
              <strong>Vibecoding</strong> — это <strong>онлайн-школа вайб-кодинга</strong>, где вы освоите <strong>создание веб-приложений</strong> с помощью искусственного интеллекта. Наши <strong>курсы vibe coding</strong> включают <strong>обучение Cursor AI</strong> и <strong>AI-инструментами</strong> — ведущим инструментам AI-разработки. Программа подходит как для подростков от 14 лет (с согласия родителей), так и для взрослых, желающих освоить востребованную профессию.
            </p>
            <p style={{ marginBottom: '20px' }}>
