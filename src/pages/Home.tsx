    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          <strong>Онлайн курсы vibe coding</strong> для подростков от 16 лет (с согласия родителей) и взрослых. Освойте <strong>Cursor AI</strong> или <strong>AI-инструментами</strong> — два направления для <strong>создания веб-приложений</strong> с помощью искусственного интеллекта.
        </p>
