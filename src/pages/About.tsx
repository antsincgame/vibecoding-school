...
const SEO = {
  title: 'Преподаватели школы ИИ программирования | Эксперты Cursor AI — Vibecoding',
  description: 'Преподаватели лучшей школы программирования с Cursor AI: Дмитрий Орлов — 15+ лет в IT, эксперт Cursor AI и ИИ-разработки. Игорь Сухоцкий — senior-разработчик, архитектор систем. Учись ИИ программированию и вайбкодингу у практикующих специалистов!',
  keywords: 'преподаватели школы ии программирования, эксперты cursor ai, обучение вайбкодингу, AI-разработка специалист, менторы вайбкодинга, лучшая школа программирования cursor преподаватели'
};
    ...
    <div style={{ minHeight: '100vh', paddingTop: '100px', position: 'relative', zIndex: 1 }}>
      ...
      <section style={{
        ...
        <h1 style={{
          ...
          marginBottom: '20px',
          color: 'var(--neon-cyan)'
        }} className="glitch" data-text="ПРЕПОДАВАТЕЛИ ШКОЛЫ ИИ ПРОГРАММИРОВАНИЯ">
          ПРЕПОДАВАТЕЛИ ШКОЛЫ ИИ ПРОГРАММИРОВАНИЯ
        </h1>
        <p style={{
          fontSize: '20px',
          ...
          Эксперты Cursor AI и вайбкодинга — практикующие специалисты с многолетним опытом в IT
        </p>
      </section>
