...
const defaultFAQs: FAQSection[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'От 16 лет и старше. Для учеников до 18 лет — с согласия родителей (законных представителей). Курс подходит как для студентов, так и для взрослых, которые хотят сменить профессию или получить дополнительный навык.'
      },
      {
