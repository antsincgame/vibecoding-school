...
const SEO = {
  ...
  description: 'Ответы на вопросы о вайбкодинге: стоимость обучения, как проходят занятия, какой компьютер нужен. Курсы вайбкодинга Cursor AI, бесплатный курс — всё о формате, оплате и карьерных перспективах.',
