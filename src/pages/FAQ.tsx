...
const SEO = {
  title: 'FAQ — школа ИИ программирования Vibecoding | Вопросы о Cursor AI и вайбкодинге',
  description: 'Ответы на вопросы о школе ИИ программирования Vibecoding: стоимость обучения Cursor AI, как проходят занятия, какой компьютер нужен. Лучшая школа программирования с Cursor — всё о формате, оплате и карьерных перспективах.',
  keywords: 'FAQ школа ии программирования, вопросы о вайбкодинге, обучение cursor ai стоимость, лучшая школа программирования cursor FAQ, бесплатный курс вайбкодинга вопросы',
...
const defaultFAQs: FAQSection[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'От 14 лет и старше. Для учеников до 18 лет — с согласия родителей (законных представителей). Курс подходит как для школьников, студентов, так и для взрослых, которые хотят сменить профессию или получить дополнительный навык.'
      },
      {
      ...
      {
        q: 'Есть ли возврат денег, если не подойдёт?',
        a: 'Да, возврат 100% стоимости в течение 3 дней, если доступ не был предоставлен, и 70% в течение 7 дней с момента получения доступа (при просмотре менее 20% материалов). Подробные условия — в публичной оферте.'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        a: 'Да, выпускники берут фриланс-заказы на Fiverr, Upwork и других платформах. Уровень дохода зависит от ваших усилий, навыков и вложенного времени.'
      },
      {
        q: 'Какие перспективы трудоустройства?',
        a: 'После курса вы можете работать как фрилансер, претендовать на позицию junior-разработчика или развивать собственные проекты. IT-рынок остаётся востребованным направлением.'
      },
      {
        q: 'Что я получу по окончании курса?',
        a: 'Портфолио из 7+ работающих проектов, оформленный GitHub-профиль, именной сертификат Vibecoding о прохождении курса (не является документом об образовании), практические навыки веб-разработки и понимание современных инструментов.'
      },
      {
    ...
    questions: [
      {
        ...
        a: 'Банковские карты, переводы, электронные кошельки. Возможна поэтапная оплата — разбейте сумму на несколько платежей.'
      },
      {
        q: 'Есть ли скидки?',
      ...
      },
      {
        ...
        a: 'Да, доступна поэтапная оплата без переплаты. Условия обсуждаются индивидуально.'
      }
    ]
  }
];
