        ...
        <div style={{
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '15px', opacity: 0.9 }}>
              ...
              от 07.05.2021 №99-З «О защите персональных данных» (далее — Закон РБ),
              Федеральным законом Российской Федерации от 27.07.2006 №152-ФЗ «О персональных
              данных» (далее — ФЗ-152, для пользователей из РФ) и иными применимыми
            ...
            <p style={{ opacity: 0.9 }}>
              1.4. Для пользователей из Российской Федерации: обработка персональных данных
              осуществляется с соблюдением требований ФЗ-152, включая принципы законности,
              справедливости, соответствия целям обработки, недопустимости объединения баз данных,
              содержащих персональные данные, обработка которых осуществляется в целях,
              несовместимых между собой (статья 5 ФЗ-152).
            </p>
          </section>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '15px', opacity: 0.9 }}>
              4.1. Правовые основания обработки персональных данных (статья 4 Закона РБ,
              статья 6 ФЗ-152 для пользователей из РФ):
            </p>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '15px', opacity: 0.9 }}>
              ...
              со статьёй 8 Закона РБ и статьёй 12 ФЗ-152 (для пользователей из РФ)
              при условии обеспечения надлежащего уровня защиты данных.
            </p>
            <p style={{ opacity: 0.9 }}>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={{ marginBottom: '15px', opacity: 0.9 }}>
              9.1. В соответствии со статьёй 11 Закона РБ «О защите персональных данных»
              и статьями 14–16 ФЗ-152 (для пользователей из РФ) вы имеете право:
            </p>
            <ul style={{ marginLeft: '20px', opacity: 0.9 }}>
            ...
            <p style={{ marginTop: '15px', opacity: 0.9 }}>
              ...
              (статья 14 Закона РБ). Для пользователей из РФ: срок ответа на запрос — 10 рабочих
              дней с момента получения (часть 4 статьи 14 ФЗ-152), с возможностью продления
              до 30 рабочих дней при необходимости.
            </p>
          </section>
          ...
          <section>
            ...
            <p style={{ marginTop: '15px', opacity: 0.9 }}>
              ...
              персональных данных. Для пользователей из Российской Федерации: вы вправе
              обратиться в Федеральную службу по надзору в сфере связи, информационных
              технологий и массовых коммуникаций (Роскомнадзор, rkn.gov.ru).
            </p>
          </section>
